...
methods = [
    ...
    {'method': 'slice_on_vocal_change', 'arguments': {'passes': 10, 'model': 'spleeter:2stems-16kHz', 'detection_chunk_size_miliseconds': 20, 'low_volume_threshold_decibels': -20.0, 'volume_drift_decibels': 0.1, 'max_clips': 20}},
