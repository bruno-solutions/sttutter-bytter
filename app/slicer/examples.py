...
def example_get_real_time_tempo(recording):
    import librosa
...
def example_get_tempo(recording):
    import librosa
    monaural_samples = Normalizer.monaural_normalization(recording)
...
def example_get_beat_time(recording):
    import librosa
    monaural_samples = Normalizer.monaural_normalization(recording)
...
def example_get_pitch(recording):
    import librosa
    monaural_samples = Normalizer.monaural_normalization(recording)
...
def example_get_volume(recording):
    import librosa
    monaural_samples = Normalizer.monaural_normalization(recording)
