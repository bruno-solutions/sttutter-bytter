...
class Slicer:
    ...
    def register(slicers, tagger):
        ...
        if isinstance(slicers, tuple):
            ...
            def registered_slicer(sample_rate, duration, threshold, seg, count, *args, **kwargs):
                slicer = Slicer(sample_rate, duration, threshold, seg, count, tagger)  # instantiate a Slicer object
                getattr(slicer, method)(*args, **kwargs)  # call the registered slicer method on the Slicer object
                return slicer.generate_clips().clips  # return the clips generated by the registered slicer method
            return
    ...
    def normalize_amplitudes(self):
        ...
        stereo_track = numpy.array(self.samples.get_array_of_samples())
        ...
        self.data = mono_track / (1 << (self.samples.sample_width * 8) - 1)
    ...
    def slice_at_volume_change(self):
        ...
        """
        VolumeSlicer(self.data).write_critical_time(self.critical.cti)
        return self
